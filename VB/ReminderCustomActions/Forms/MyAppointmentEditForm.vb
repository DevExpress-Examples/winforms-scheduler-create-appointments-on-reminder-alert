...
Namespace ReminderCustomActions
	...
	Public Class MyAppointmentFormController
		...
		Public Property CustomPrice() As Decimal
			Get
				Return If(EditedAppointmentCopy.CustomFields("CustomPrice") IsNot Nothing, DirectCast(EditedAppointmentCopy.CustomFields("CustomPrice"), Decimal), 0)
			End Get
	   ...
	   Private Property SourceCustomPrice() As Decimal
		   Get
			   Return DirectCast(SourceAppointment.CustomFields("CustomPrice"), Decimal)
		   End Get
		   Set(ByVal value As Decimal)
